...
public interface AppointmentFilter extends ModelFilter<AppointmentImpl, AppointmentModel> {
    ...
    public static AppointmentFilter of(FilterType type, String heading, String subHeading, Predicate<AppointmentModel> predicate, String sqlFilterExpr,
        ...
        if (null == initializeNew) {
            return of(type, heading, subHeading, predicate, sqlFilterExpr, applyValues, (m) -> m.setUser(new UserModel(App.getCurrentUserObsolete())));
        }
    ...
    public static AppointmentFilter all() {
        return AppointmentFilter.of(FilterType.ALL,
                ...
                (ps, i) -> i,
                // initializeNew
                (m) -> m.setUser(new UserModel(App.getCurrentUserObsolete())));
    }
    ...
    public static AppointmentFilter byCustomer(CustomerImpl customer) {
        return byCustomer(customer.getPrimaryKey(),
                ...
                (m) -> {
                    ...
                    m.setUser(new UserModel(App.getCurrentUserObsolete()));
                });
    }
    ...
    public static AppointmentFilter byUser(UserImpl user) {
        return byUser(user.getPrimaryKey(), (user.getPrimaryKey() == App.getCurrentUserObsolete().getPrimaryKey())
    ...
    public static AppointmentFilter allMyItems() {
        return byUser(App.getCurrentUserObsolete().getPrimaryKey(),
                ResourceBundleLoader.getResourceString(ManageAppointments.class, ManageAppointments.RESOURCEKEY_ALLMYAPPOINTMENTS),
                (m) -> m.setUser(new UserModel(App.getCurrentUserObsolete())));
    }
    ...
    public static AppointmentFilter myBeforeDate(LocalDate date) {
        return byCustomerBeforeDate(App.getCurrentUserObsolete().getPrimaryKey(), date,
    ...
    public static AppointmentFilter myOnOrAfterDate(LocalDate date) {
        return byUserOnOrAfterDate(App.getCurrentUserObsolete().getPrimaryKey(), date,
    ...
    public static AppointmentFilter myOn(LocalDate date) {
        return byUserWithin(App.getCurrentUserObsolete().getPrimaryKey(), date, date,
    ...
    public static AppointmentFilter myWithin(LocalDate start, LocalDate end) {
        return byUserWithin(App.getCurrentUserObsolete().getPrimaryKey(), start, end,
    ...
    public static AppointmentFilter byUserCurrentAndFuture(UserImpl user) {
        return byUserOnOrAfterDate(user.getPrimaryKey(), LocalDate.now(), (user.getPrimaryKey() == App.getCurrentUserObsolete().getPrimaryKey())
    ...
    public static AppointmentFilter myCurrentAndFuture() {
        return byUserOnOrAfterDate(App.getCurrentUserObsolete().getPrimaryKey(), LocalDate.now(),
                ResourceBundleLoader.getResourceString(ManageAppointments.class, ManageAppointments.RESOURCEKEY_MYCURRENTANDFUTURE),
                (m) -> m.setUser(new UserModel(App.getCurrentUserObsolete())));
    }
    ...
    public static AppointmentFilter byUserPast(UserImpl user) {
        return byUserBeforeDate(user.getPrimaryKey(), LocalDate.now(), (user.getPrimaryKey() == App.getCurrentUserObsolete().getPrimaryKey())
