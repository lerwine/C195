...
/**
 * Defines resource bundle keys for the {@code scheduler/view/customer/ManageCustomers} resource bundle.
 *
 * @author Leonard T. Erwine (Student ID 356334) &lt;lerwine@wgu.edu&gt;
 */
public interface ManageCustomersResourceKeys {
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Customer Name"}.
     */
    public static final String RESOURCEKEY_CUSTOMERNAME = "customerName";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Customers by Country"}.
     */
