...
/**
 * Defines resource bundle keys for the {@code view/view/Main} resource bundle.
 *
 * @author Leonard T. Erwine (Student ID 356334) &lt;lerwine@wgu.edu&gt;
 */
public interface MainResourceKeys {
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading appointment listing."}.
     */
    public static final String RESOURCEKEY_APPOINTMENTLOADERROR = "appointmentLoadError";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Appointment Reminder"}.
     */
    public static final String RESOURCEKEY_APPOINTMENTREMINDER = "appointmentReminder";
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading calendar view."}.
     */
    public static final String RESOURCEKEY_CALENDARLOADERROR = "calendarLoadError";
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading country listing."}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading customer listing."}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Dismiss"}.
     */
    public static final String RESOURCEKEY_DISMISS = "dismiss";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Dismiss All"}.
     */
    public static final String RESOURCEKEY_DISMISSALL = "dismissAll";
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error checking impending appointments."}.
     */
    public static final String RESOURCEKEY_ERRORCHECKINGIMPENDINGAPPOINTMENTS = "errorCheckingImpendingAppointments";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading address edit window."}.
     */
    public static final String RESOURCEKEY_ERRORLOADINGADDRESSEDITWINDOW = "errorLoadingAddressEditWindow";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading appointment edit window."}.
     */
    public static final String RESOURCEKEY_ERRORLOADINGAPPOINTMENTEDITWINDOW = "errorLoadingAppointmentEditWindow";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading city edit window."}.
     */
    public static final String RESOURCEKEY_ERRORLOADINGCITYEDITWINDOW = "errorLoadingCityEditWindow";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading country edit window."}.
     */
    public static final String RESOURCEKEY_ERRORLOADINGCOUNTRYEDITWINDOW = "errorLoadingCountryEditWindow";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading customer edit window."}.
     */
    public static final String RESOURCEKEY_ERRORLOADINGCUSTOMEREDITWINDOW = "errorLoadingCustomerEditWindow";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading new address edit window."}.
     */
    public static final String RESOURCEKEY_ERRORLOADINGNEWADDRESSWINDOW = "errorLoadingNewAddressWindow";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading new appointment edit window."}.
     */
    public static final String RESOURCEKEY_ERRORLOADINGNEWAPPOINTMENTWINDOW = "errorLoadingNewAppointmentWindow";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading new customer edit window."}.
     */
    public static final String RESOURCEKEY_ERRORLOADINGNEWCUSTOMERWINDOW = "errorLoadingNewCustomerWindow";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading new user edit window."}.
     */
    public static final String RESOURCEKEY_ERRORLOADINGNEWUSERWINDOW = "errorLoadingNewUserWindow";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading user edit window."}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Manage Addresses"}.
     */
    public static final String RESOURCEKEY_MANAGEADDRESSES = "manageAddresses";
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Monthly Calendar"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Overview"}.
     */
    public static final String RESOURCEKEY_OVERVIEW = "overview";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading overview window."}.
     */
    public static final String RESOURCEKEY_OVERVIEWLOADERROR = "overviewLoadError";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Scheduler Help"}.
     */
    public static final String RESOURCEKEY_SCHEDULERHELP = "schedulerHelp";
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Error loading user listing."}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the text for {@code "Weekly Calendar"}.
     */
    public static final String RESOURCEKEY_WEEKLYCALENDAR = "weeklyCalendar";
