...
/**
 * Defines resource bundle keys for the {@code scheduler/view/EditItem} resource bundle.
 *
 * @author Leonard T. Erwine (Student ID 356334) &lt;lerwine@wgu.edu&gt;
 */
public interface EditItemResourceKeys {
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for
     * {@code "There are unsaved changes.\u000d\u000aAre sure you want to discard the changes to this record?"}.
     */
    public static final String RESOURCEKEY_AREYOUSUREDISCARDCHANGES = "areYouSureDiscardChanges";
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Cancel New Item"}.
     */
    public static final String RESOURCEKEY_CONFIRMCANCELNEW = "confirmCancelNew";
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Discard Changes"}.
     */
    public static final String RESOURCEKEY_CONFIRMDISCARDCHANGES = "confirmDiscardChanges";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Created"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "%s by %s"}.
     */
    public static final String RESOURCEKEY_ONBYNAME = "onByName";
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Save"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Updated"}.
     */
    public static final String RESOURCEKEY_UPDATED = "updated";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Validation Error"}.
     */
