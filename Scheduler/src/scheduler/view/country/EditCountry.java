...
public final class EditCountry extends EditItem.EditController<CountryModel> {
...
ot be deleted."}.
    ...
    protected void updateDao() {
        getModel().getDataObject().setName(normalizedName.get());
    }
    ...
    @Override
    protected BooleanExpression getValidationExpression() { return normalizedName.isNotEmpty(); }
