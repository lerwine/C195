 ...
 */
public interface EditCountryResourceKeys {
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Country \"%s\""}.
     */
     ...
     */
    public static final String RESOURCEKEY_NAMECOLUMNHEADING = "nameColumnHeading";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Name:"}.
     */
    public static final String RESOURCEKEY_NAMEFIELDLABEL = "nameFieldLabel";
