...
/**
 * A {@link SimpleStringProperty} that stores non-null {@link String} values.
 * Null values supplied to this property will be converted to empty strings.
...
public class NonNullableStringProperty extends SimpleStringProperty {
    ...
    @Override
    public void set(String newValue) { super.set((newValue == null) ? "" : ((trimming) ? newValue.trim() : newValue)); }

    @Override
    public void setValue(String v) { super.set((v == null) ? "" : ((trimming) ? v.trim() : v)); }
