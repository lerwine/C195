...
public class SchemaHelper {
     ...
     *
     * @param column The column to test.
     * @return {@code true} if {@link DbColumn#getUsage()} is {@link ColumnUsage#DATA}, {@link ColumnUsage#UNIQUE_KEY}
     * {@link ColumnUsage#CRYPTO_HASH} or {@link ColumnUsage#FOREIGN_KEY}; otherwise, {@code false}.
     */
    public static boolean isEntityDataOrRef(DbColumn column) {
        switch (column.getUsage()) {
            case DATA:
            case UNIQUE_KEY:
            case FOREIGN_KEY:
