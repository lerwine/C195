 ...
 * @param <U>
 */
public interface TimestampColumnValueFilter<T extends DataAccessObject, U extends Temporal> extends ColumnValueFilter<T, Timestamp, TimestampValueFilter<U>> {

    public static <T extends DataAccessObject, U extends Temporal> TimestampColumnValueFilter<T, U> of(DbColumn column, TimestampValueFilter<U> filter,
            Function<T, Timestamp> getColumnValue) {
        int h = 0;
