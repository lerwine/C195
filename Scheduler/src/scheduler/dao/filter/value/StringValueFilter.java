...
public interface StringValueFilter extends ValueFilter<String>, Predicate<String> {
    ...
    public static StringValueFilter ofWcPattern(String value, boolean negate) {
        ...
        if (negate) {
            return new StringValueFilter() {
                ...
                @Override
                public boolean test(String t) {
                    return null != t && pattern.matcher(t).find();
                }
        ...
        switch (operator) {
            ...
            case GREATER_THAN:
                return new StringValueFilter() {
                    ...
                    @Override
                    public boolean test(String t) {
                        return null != t && str.compareTo(t) > 0;
                    }
        ...
        switch (operator) {
            case EQUALS_CASE_INSENSITIVE:
                return new StringValueFilter() {
                    ...
                    @Override
                    public boolean test(String t) {
                        return null != t && t.equalsIgnoreCase(str);
                    }
                    ...
                    @Override
                    public void accept(PreparedStatement ps, int index) throws SQLException {
                        Loggers.SVF_LOG.finer(() -> String.format("Setting parameter at index %d to %s", index, LogHelper.toLogText(whereParameter)));
                        ps.setString(index, whereParameter);
                    }
            ...
            case STARTS_WITH:
                return new StringValueFilter() {
                    ...
                    @Override
                    public boolean test(String t) {
                        return null != t && t.toLowerCase().startsWith(lcValue);
                    }
            ...
            case ENDS_WITH:
                return new StringValueFilter() {
                    ...
                    @Override
                    public boolean test(String t) {
                        return null != t && t.toLowerCase().endsWith(lcValue);
                    }
            ...
            default:
                return new StringValueFilter() {
                    ...
                    @Override
                    public boolean test(String t) {
                        return null != t && t.toLowerCase().contains(lcValue);
                    }
    ...
    public default void accept(PreparedStatement ps, int index) throws SQLException {
        String value = get();
        Loggers.SVF_LOG.finer(() -> String.format("Setting parameter at index %d to %s", index, LogHelper.toLogText(value)));
