...
public class ItemEventManager<T extends ItemEvent<?>> {
     ...
     * @return {@code true} if the {@code listener} was added to the event listener chain;
     * otherwise, {@code false} if {@code listener} was null or it had already been added.
     */
     ...
     * @return {@code true} if the {@code listener} was removed to the event listener chain;
     * otherwise, {@code false} if {@code listener} was null or it was not part of the event listener chain.
     */
    ...
    private class Link {
        ...
        /**
         * Fires an event for the current and preceding listeners.
         * Invokes the preceding listeners first, and then the current one.
