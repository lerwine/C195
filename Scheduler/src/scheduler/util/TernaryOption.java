...
class TernaryOption<T, S, U> {
    ...
    public boolean isPrimary() { return primary.isPresent() && primary.get(); }
    public boolean isSecondary() { return primary.isPresent() && !primary.get(); }
    public boolean isTertiary() { return !primary.isPresent(); }
    public T getPrimary() {
        if (!isPrimary())
