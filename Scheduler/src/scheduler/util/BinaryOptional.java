...
/**
 * An object that contains one or none of 2 possible value options. This is is somewhat similar to {@link Optional} with a secondary option value.
 *
...
public final class BinaryOptional<T, U> {
     ...
     *
     * @return {@code true} if this object contains the primary or secondary value option; otherwise, {@code false} to indicate that this object
     * contains no value option.
     */
     ...
     * Applies a {@link Function} according to the option value being stored.
     * <p>
     * This is similar to {@link #map(java.util.function.Function, java.util.function.Function)}, except that it will throw a
     * {@link NullPointerException} if either of the returned values are null.</p>
     *
     * @param <S> The type of value to be returned.
     * @param ifPrimary The {@link Function} to apply if this contains the primary option value.
     * @param ifSecondary The {@link Function} to apply if this contains the secondary option value.
    ...
    public void get() {
        throw new UnsupportedOperationException("Not supported yet."); // FIXME: Implement scheduler.util.BinaryOptional#get
    }
