 ...
 * <dl>
 * <dt>{@link #BASE_EVENT_NAME "SCHEDULER_CITY_FAILED_EVENT"} &lArr; {@link #OP_EVENT_TYPE "SCHEDULER_CITY_OP_EVENT"} &lArr; {@link #CITY_EVENT_TYPE "SCHEDULER_CITY_EVENT"} &lArr;
 * {@link ModelEvent#MODEL_EVENT_TYPE "SCHEDULER_MODEL_EVENT"} &lArr; {@link javafx.event.Event#ANY "EVENT"}</dt>
 * <dd>
 * <dl>
 * <dt>&#x21B3; SCHEDULER_CITY_SAVE_FAILED</dt>
 * <dd>&rarr; {@link #SAVE_FAILED}
 * <dl>
 * <dt>&#x21B3; SCHEDULER_CITY_INSERT_FAILED</dt>
 * <dd>&rarr; {@link #INSERT_FAILED}
 * <dl>
 * <dt>&#x21B3; SCHEDULER_CITY_INSERT_FAULTED</dt>
 * <dd>&rarr; {@link #INSERT_FAULTED}</dd>
 * <dt>&#x21B3; SCHEDULER_CITY_INSERT_INVALID</dt>
 * <dd>&rarr; {@link #INSERT_INVALID}</dd>
 * <dt>&#x21B3; SCHEDULER_CITY_INSERT_CANCELED</dt>
 * <dd>&rarr; {@link #INSERT_CANCELED}</dd>
 * </dl></dd>
 * <dt>&#x21B3; SCHEDULER_CITY_UPDATE_FAILED</dt>
 * <dd>&rarr; {@link #UPDATE_FAILED}
 * <dl>
 * <dt>&#x21B3; SCHEDULER_CITY_UPDATE_FAULTED</dt>
 * <dd>&rarr; {@link #UPDATE_FAULTED}</dd>
 * <dt>&#x21B3; SCHEDULER_CITY_UPDATE_INVALID</dt>
 * <dd>&rarr; {@link #UPDATE_INVALID}</dd>
 * <dt>&#x21B3; SCHEDULER_CITY_UPDATE_CANCELED</dt>
 * <dd>&rarr; {@link #UPDATE_CANCELED}</dd>
 * </dl></dd>
 * </dl></dd>
 * <dt>&#x21B3; SCHEDULER_CITY_DELETE_FAILED</dt>
 * <dd>&rarr; {@link #DELETE_FAILED}
 * <dl>
 * <dt>&#x21B3; SCHEDULER_CITY_DELETE_FAULTED</dt>
 * <dd>&rarr; {@link #DELETE_FAULTED}</dd>
 * <dt>&#x21B3; SCHEDULER_CITY_DELETE_INVALID</dt>
 * <dd>&rarr; {@link #DELETE_INVALID}</dd>
 * <dt>&#x21B3; SCHEDULER_CITY_DELETE_CANCELED</dt>
