 ...
 * <dl>
 * <dt>(inherit) SCHEDULER_CUSTOMER_INSERT_SUCCESS</dt>
 * <dd>&rarr; {@link #INSERT_SUCCESS}</dd>
 * <dt>(inherit) SCHEDULER_CUSTOMER_UPDATE_SUCCESS</dt>
 * <dd>&rarr; {@link #UPDATE_SUCCESS}</dd>
 * </dl></dd>
 * <dt>(inherit) SCHEDULER_CUSTOMER_DELETE_SUCCESS</dt>
...
public final class CustomerSuccessEvent extends CustomerEvent {
     ...
     */
    public static final EventType<CustomerSuccessEvent> SUCCESS_EVENT_TYPE = new EventType<>(CHANGE_EVENT_TYPE, BASE_EVENT_NAME);
