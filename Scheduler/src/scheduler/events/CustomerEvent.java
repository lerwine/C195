 ...
 * <dl>
 * <dt>{@link #CUSTOMER_EVENT_TYPE "SCHEDULER_CUSTOMER_EVENT"} &lArr; {@link ModelEvent#MODEL_EVENT_TYPE "SCHEDULER_MODEL_EVENT"} &lArr;
...
public abstract class CustomerEvent extends ModelEvent<CustomerDAO, CustomerModel> {
    ...
    public static final CustomerEvent createInsertSuccessEvent(CustomerModel target, Object source) {
        return new CustomerSuccessEvent(target, source, CustomerSuccessEvent.INSERT_SUCCESS);
    }

    public static final CustomerEvent createUpdateSuccessEvent(CustomerModel target, Object source) {
        return new CustomerSuccessEvent(target, source, CustomerSuccessEvent.UPDATE_SUCCESS);
    }

    public static final CustomerEvent createDeleteSuccessEvent(CustomerModel target, Object source) {
        return new CustomerSuccessEvent(target, source, CustomerSuccessEvent.DELETE_SUCCESS);
    }

    public static final CustomerEvent createInsertInvalidEvent(CustomerModel target, Object source, String message) {
        return new CustomerFailedEvent(target, message, null, source, CustomerFailedEvent.INSERT_INVALID);
    }

    public static final CustomerEvent createUpdateInvalidEvent(CustomerModel target, Object source, String message) {
        return new CustomerFailedEvent(target, message, null, source, CustomerFailedEvent.UPDATE_INVALID);
    }

    public static final CustomerEvent createDeleteInvalidEvent(CustomerModel target, Object source, String message) {
        return new CustomerFailedEvent(target, message, null, source, CustomerFailedEvent.DELETE_INVALID);
    }

    public static final CustomerEvent createInsertFaultedEvent(CustomerModel target, Object source, Throwable ex) {
    ...
    public static final CustomerEvent createUpdateFaultedEvent(CustomerModel target, Object source, Throwable ex) {
        if (null != ex && ex instanceof OperationFailureException) {
    ...
    public static final CustomerEvent createDeleteFaultedEvent(CustomerModel target, Object source, Throwable ex) {
        if (null != ex && ex instanceof OperationFailureException) {
    ...
    public static final CustomerEvent createInsertCanceledEvent(CustomerModel target, Object source, InterruptedException ex) {
        if (null == ex) {
    ...
    public static final CustomerEvent createUpdateCanceledEvent(CustomerModel target, Object source, InterruptedException ex) {
        if (null == ex) {
    ...
    public static final CustomerEvent createDeleteCanceledEvent(CustomerModel target, Object source, InterruptedException ex) {
        if (null == ex) {
    ...
    public static final CustomerEvent createInsertCanceledEvent(CustomerModel target, Object source) {
        return createInsertCanceledEvent(target, source, null);
    }

    public static final CustomerEvent createUpdateCanceledEvent(CustomerModel target, Object source) {
        return createUpdateCanceledEvent(target, source, null);
    }

    public static final CustomerEvent createDeleteCanceledEvent(CustomerModel target, Object source) {
        return createDeleteCanceledEvent(target, source, null);
    }

    public static CustomerEvent createInsertInvalidEvent(CustomerModel target, Object source, AddressFailedEvent event) {
        return new CustomerFailedEvent(target, source, CustomerFailedEvent.INSERT_INVALID, event);
    }

    public static CustomerEvent createUpdateInvalidEvent(CustomerModel target, Object source, AddressFailedEvent event) {
