 ...
 * <dl>
 * <dt>{@link #USER_EVENT_TYPE "SCHEDULER_USER_EVENT"} &lArr; {@link ModelEvent#MODEL_EVENT_TYPE "SCHEDULER_MODEL_EVENT"} &lArr;
...
public abstract class UserEvent extends ModelEvent<UserDAO, UserModel> {
    ...
    public static final UserEvent createInsertSuccessEvent(UserModel target, Object source) {
        return new UserSuccessEvent(target, source, UserSuccessEvent.INSERT_SUCCESS);
    }

    public static final UserEvent createUpdateSuccessEvent(UserModel target, Object source) {
        return new UserSuccessEvent(target, source, UserSuccessEvent.UPDATE_SUCCESS);
    }

    public static final UserEvent createDeleteSuccessEvent(UserModel target, Object source) {
        return new UserSuccessEvent(target, source, UserSuccessEvent.DELETE_SUCCESS);
    }

    public static final UserEvent createInsertInvalidEvent(UserModel target, Object source, String message) {
        return new UserFailedEvent(target, message, null, source, UserFailedEvent.INSERT_INVALID);
    }

    public static final UserEvent createUpdateInvalidEvent(UserModel target, Object source, String message) {
        return new UserFailedEvent(target, message, null, source, UserFailedEvent.UPDATE_INVALID);
    }

    public static final UserEvent createDeleteInvalidEvent(UserModel target, Object source, String message) {
        return new UserFailedEvent(target, message, null, source, UserFailedEvent.DELETE_INVALID);
    }

    public static final UserEvent createInsertFaultedEvent(UserModel target, Object source, Throwable ex) {
    ...
    public static final UserEvent createUpdateFaultedEvent(UserModel target, Object source, Throwable ex) {
        if (null != ex && ex instanceof OperationFailureException) {
    ...
    public static final UserEvent createDeleteFaultedEvent(UserModel target, Object source, Throwable ex) {
        if (null != ex && ex instanceof OperationFailureException) {
    ...
    public static final UserEvent createInsertCanceledEvent(UserModel target, Object source, InterruptedException ex) {
        if (null == ex) {
    ...
    public static final UserEvent createUpdateCanceledEvent(UserModel target, Object source, InterruptedException ex) {
        if (null == ex) {
    ...
    public static final UserEvent createDeleteCanceledEvent(UserModel target, Object source, InterruptedException ex) {
        if (null == ex) {
    ...
    public static final UserEvent createInsertCanceledEvent(UserModel target, Object source) {
        return createInsertCanceledEvent(target, source, null);
    }

    public static final UserEvent createUpdateCanceledEvent(UserModel target, Object source) {
        return createUpdateCanceledEvent(target, source, null);
    }

    public static final UserEvent createDeleteCanceledEvent(UserModel target, Object source) {
