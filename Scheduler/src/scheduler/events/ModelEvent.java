 ...
 * <dd>{@link scheduler.dao.DataAccessObject} &rArr; {@link scheduler.dao.DataAccessObject.DaoFactory} &rArr; {@link scheduler.model.fx.EntityModel.EntityModelFactory}</dd>
 * <dt>{@link AppointmentEvent}</dt>
 * <dd>{@link scheduler.dao.DataAccessObject} &rArr; {@link scheduler.dao.DataAccessObject.DaoFactory} &rArr; {@link scheduler.model.fx.EntityModel.EntityModelFactory} &rArr;
 * {@link scheduler.AppointmentAlertManager}</dd>
 * </dl></dd>
