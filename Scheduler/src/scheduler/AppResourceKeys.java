...
/**
 * Defines resource bundle keys for the {@code scheduler/App} resource bundle.
 *
 * @author Leonard T. Erwine (Student ID 356334) &lt;lerwine@wgu.edu&gt;
 */
public interface AppResourceKeys {

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Abort"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Active Customers"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Administrator"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "All Addresses"}.
     */
    public static final String RESOURCEKEY_ALLADDRESSES = "allAddresses";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "All Cities"}.
     */
    public static final String RESOURCEKEY_ALLCITIES = "allCities";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "All Countries"}.
     */
    public static final String RESOURCEKEY_ALLCOUNTRIES = "allCountries";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "All Customers"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Appointment Scheduler"}.
     */
    public static final String RESOURCEKEY_APPOINTMENTSCHEDULER = "appointmentScheduler";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Corporate Location"}.
     */
    public static final String RESOURCEKEY_APPOINTMENTTYPE_CORPORATE = "appointmentType_corporate";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Customer Site"}.
     */
    public static final String RESOURCEKEY_APPOINTMENTTYPE_CUSTOMER = "appointmentType_customer";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Other in-person meeting"}.
     */
    public static final String RESOURCEKEY_APPOINTMENTTYPE_OTHER = "appointmentType_other";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Phone Conference"}.
     */
    public static final String RESOURCEKEY_APPOINTMENTTYPE_PHONE = "appointmentType_phone";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Virtual Meeting"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Cancelling\u2026"}.
     */
    public static final String RESOURCEKEY_CANCELLING = "cancelling";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Caused By:"}.
     */
    public static final String RESOURCEKEY_CAUSEDBY = "causedBy";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Checking dependencies\u2026"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Completing operation\u2026"}.
     */
    public static final String RESOURCEKEY_COMPLETINGOPERATION = "completingOperation";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Confirm Delete"}.
     */
    public static final String RESOURCEKEY_CONFIRMDELETE = "confirmDelete";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Connected to database"}.
     */
    public static final String RESOURCEKEY_CONNECTEDTODB = "connectedToDb";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Connecting to database"}.
     */
    public static final String RESOURCEKEY_CONNECTINGTODB = "connectingToDb";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Corporate Office"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Delete Failure"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Deleting Record"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Error Code:"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "File \"%s\" not found."}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "FXML Loader Error"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Inactive Customers"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Load Error"}.
     */
    public static final String RESOURCEKEY_LOADERRORTITLE = "loadErrorTitle";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Loading Addresses"}.
     */
    public static final String RESOURCEKEY_LOADINGADDRESSES = "loadingAddresses";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Loading Appointments"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Log Message:"}.
     */
    public static final String RESOURCEKEY_LOGMESSAGE = "logMessage";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Message:"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "%d of %d"}.
     */
    public static final String RESOURCEKEY_NOFN = "nOfN";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "No item was selected."}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Nothing selected"}.
     */
    public static final String RESOURCEKEY_NOTHINGSELECTED = "nothingSelected";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "%d%% complete"}.
     */
    public static final String RESOURCEKEY_NPERCENTCOMPLETE = "nPercentComplete";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Original error message:"}.
     */
    public static final String RESOURCEKEY_ORIGINALERRORMESSAGE = "originalErrorMessage";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Please wait\u2026"}.
     */
    public static final String RESOURCEKEY_PLEASEWAIT = "pleaseWait";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Reading from Database"}.
     */
    public static final String RESOURCEKEY_READINGFROMDB = "readingFromDb";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Related Exceptions:"}.
     */
    public static final String RESOURCEKEY_RELATEDEXCEPTIONS = "relatedExceptions";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Satellite Office"}.
     */
    public static final String RESOURCEKEY_SATELLITEOFFICE = "satelliteOffice";
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Record Save Failure"}.
     */
    public static final String RESOURCEKEY_SAVEFAILURE = "saveFailure";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Saving Changes"}.
     */
    public static final String RESOURCEKEY_SAVINGCHANGES = "savingChanges";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for
     * {@code "Unexpected error trying to load application settings.\u000d\u000aSee logs for details."}.
     */
    public static final String RESOURCEKEY_SETTINGSLOADERROR = "settingsLoadError";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Stack Trace:"}.
     */
    public static final String RESOURCEKEY_STACKTRACE = "stackTrace";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "State:"}.
     */
    ...
    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Unexpected Error"}.
     */
    public static final String RESOURCEKEY_UNEXPECTEDERRORTITLE = "unexpectedErrorTitle";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Unknown"}.
     */
    public static final String RESOURCEKEY_UNKNOWN = "unknown";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Warning"}.
     */
    public static final String RESOURCEKEY_WARNING = "warning";

    /**
     * Resource key in the current {@link java.util.ResourceBundle} that contains the locale-specific text for {@code "Working"}.
     */
