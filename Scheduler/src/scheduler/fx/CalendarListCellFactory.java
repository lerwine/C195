 ...
 */
public class CalendarListCellFactory implements Callback<ListView<CalendarCellData>, ListCell<CalendarCellData>>, EventTarget {

    private static final Logger LOG = LogHelper.setLoggerAndHandlerLevels(Logger.getLogger(CalendarListCellFactory.class.getName()), Level.FINER);
//    private static final Logger LOG = Logger.getLogger(CalendarListCellFactory.class.getName());
    ...
    public CalendarListCell call(ListView<CalendarCellData> param) {
        ...
        CalendarListCell tableCell = new CalendarListCell(this);
