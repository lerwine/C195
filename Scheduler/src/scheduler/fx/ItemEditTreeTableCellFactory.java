 ...
 */
public abstract class ItemEditTreeTableCellFactory<D extends DataAccessObject, M extends EntityModel<D>, E extends OperationRequestEvent<D, M>>
        implements Callback<TreeTableColumn<M, M>, TreeTableCell<M, M>>, EventTarget {

//    private static final Logger LOG = LogHelper.setLoggerAndHandlerLevels(Logger.getLogger(ItemEditTreeTableCellFactory.class.getName()), Level.FINE);
    private static final Logger LOG = Logger.getLogger(ItemEditTreeTableCellFactory.class.getName());

    private final EventHandlerManager eventHandlerManager;
    private final ObjectProperty<EventHandler<E>> onItemActionRequest;

    @SuppressWarnings("unchecked")
    public ItemEditTreeTableCellFactory() {
    ...
    @Override
    public ItemEditTreeTableCell<D, M, E> call(TreeTableColumn<M, M> param) {
        LOG.entering(LOG.getName(), "call", param);
        ItemEditTreeTableCell<D, M, E> tableCell = new ItemEditTreeTableCell<>(this);
