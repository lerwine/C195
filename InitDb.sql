...
INSERT INTO `U03vHM`.`country`
	...
	VALUES (1, 'us', '2019-11-25 07:13:59', 'test', '2019-11-25 07:13:59', 'test');
INSERT INTO `U03vHM`.`city`
	(`cityId`, `city`, `countryId`, `createDate`, `createdBy`, `lastUpdate`, `lastUpdateBy`)
	VALUES (1, 'washington_dc', 1, '2019-11-25 11:31:22', 'test', '2019-11-25 11:31:22', 'test');
...
INSERT INTO `U03vHM`.`city`
	(`cityId`, `city`, `countryId`, `createDate`, `createdBy`, `lastUpdate`, `lastUpdateBy`)
	VALUES (2, 'san_jose', 1, '2019-11-26 09:55:25', 'test', '2019-11-26 09:55:25', 'test');
INSERT INTO `U03vHM`.`address`
	(`addressId`, `address`, `address2`, `cityId`, `postalCode`, `phone`, `createDate`, `createdBy`, `lastUpdate`, `lastUpdateBy`)
...
INSERT INTO `U03vHM`.`country`
	(`countryId`, `country`, `createDate`, `createdBy`, `lastUpdate`, `lastUpdateBy`)
	VALUES (2, 'de', '2019-11-27 16:43:19', 'test', '2019-11-27 16:43:19', 'test');
INSERT INTO `U03vHM`.`city`
	(`cityId`, `city`, `countryId`, `createDate`, `createdBy`, `lastUpdate`, `lastUpdateBy`)
...
INSERT INTO `U03vHM`.`country`
	(`countryId`, `country`, `createDate`, `createdBy`, `lastUpdate`, `lastUpdateBy`)
	VALUES (3, 'in', '2019-11-27 16:44:05', 'test', '2019-11-27 16:44:05', 'test');
INSERT INTO `U03vHM`.`city`
	(`cityId`, `city`, `countryId`, `createDate`, `createdBy`, `lastUpdate`, `lastUpdateBy`)
	VALUES (5, 'new_delhi', 1, '2019-11-27 16:44:19', 'test', '2019-11-27 16:44:19', 'test');
INSERT INTO `U03vHM`.`city`
	(`cityId`, `city`, `countryId`, `createDate`, `createdBy`, `lastUpdate`, `lastUpdateBy`)
	VALUES (6, 'bangalore', 1, '2019-11-27 16:44:38', 'test', '2019-11-27 16:44:38', 'test');
INSERT INTO `U03vHM`.`country`
	(`countryId`, `country`, `createDate`, `createdBy`, `lastUpdate`, `lastUpdateBy`)
	VALUES (4, 'pr', '2019-11-27 16:45:01', 'test', '2019-11-27 16:45:01', 'test');
INSERT INTO `U03vHM`.`city`
	(`cityId`, `city`, `countryId`, `createDate`, `createdBy`, `lastUpdate`, `lastUpdateBy`)
